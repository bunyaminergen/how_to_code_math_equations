...
CONTENTS
1.  Start with Basics --------------------------------- [line  38 to  74]
2.  Intermediate -------------------------------------- [line  75 to 263]
    2.a. Variance ------------------------------------- [line  84 to 127]
    2.b. Standard Deviation (Sample) ------------------ [line 128 to 156]
    2.c. Confidence Interval -------------------------- [line 157 to 263]
        2.c.a Confidence Level Value (Z-score) -------- [line 208 to 263]
3.  Simple Linear Regression -------------------------- [line 264 to 527]
    3.a. β1 (slope) ----------------------------------- [line 311 to 414]
        3.a.a. Pearson correlation coefficient -------- [line 343 to 414]
    3.b. β0 (intercept) ------------------------------- [line 415 to 426]
    3.c R-Squared (Coefficient of determination) ------ [line 427 to 488]
        3.c.a RSS (Residual Sum of Squares) ----------- [line 448 to 465]
        3.c.b TSS (Total Sum of Squares) -------------- [line 466 to 488]
    3.d Adjusted R-Squared ---------------------------- [line 489 to 527]
 Resources -------------------------------------------- [line 528 to 556]
"""
########################################################################################################################
########################################################################################################################
# 1. Start with Basics
...
# https://raw.githubusercontent.com/bunyaminergen/how_to_code_math_equations/2540b681eec2c50a17b87418f09b57b27e1397c0/pearson_correlation_coefficient.svg
...
I am adding the stages of the above code to the below so that it can be followed easily.
     [(x_i - x_mean)      for x_i in x]  *     [(y_i - y_mean)      for y_i in y]
    ([(x_i - x_mean) ** 2 for x_i in x]) *    ([(y_i - y_mean) ** 2 for y_i in y]) 
(sum([(x_i - x_mean) ** 2 for x_i in x]) * sum([(y_i - y_mean) ** 2 for y_i in y])) 
(sum([(x_i - x_mean) ** 2 for x_i in x]) * sum([(y_i - y_mean) ** 2 for y_i in y])) ** 0.5
"""
"""
